...
Ответь ТОЛЬКО валидным JSON.`;
      ...
      systemPrompt = `Ты — игровой мастер симулятора жизни фрилансера "Max Freelance Pain". Генерируй случайные жизненные события, которые происходят с фрилансером в его повседневной жизни.

ПРАВИЛА:
- События должны быть смешными, жизненными, узнаваемыми для фрилансеров
...
- Темы: еда, коммуналка, кот, здоровье, транспорт, гаджеты, подписки, друзья, соседи, бытовуха, прокрастинация
